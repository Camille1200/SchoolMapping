...
public class AdminLoginForm extends javax.swing.JFrame {
    ...
    private void btnAdminLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdminLoginActionPerformed
        ...
        try{
           boolean isTrueCredentials = _db.loginAdmin(this.txtUsername.getText(), this.txtPassword.getText());
           
           if(isTrueCredentials)
           {
               JOptionPane.showMessageDialog(null, "You may now login!");
               MaintenanceForm _maintenanceForm = new MaintenanceForm();
               _maintenanceForm.setLoggedUser(this.txtUsername.getText());
               _maintenanceForm.setVisible(true);
              
               this.setVisible(false);
           }else{
               JOptionPane.showMessageDialog (null, "User not known!", "Error: User not found", JOptionPane.ERROR_MESSAGE);
           }
        }catch(Exception ex)
        {
